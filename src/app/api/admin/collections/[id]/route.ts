...
import { deleteCollectionService, patchCollectionService } from "@/shared/server/services/collection";
...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    console.error("PATCH /api/admin/collections/[id] error:", e);
...
export async function DELETE(_req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    console.error("DELETE /api/admin/collections/[id] error:", e);
    return NextResponse.json(
